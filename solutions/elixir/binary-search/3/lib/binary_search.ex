defmodule BinarySearch do
  ...
  defp binary_search(_, _, initial_position, last_position) when initial_position > last_position, do: :not_found
  
  defp binary_search(numbers, key, initial_position, last_position) do
